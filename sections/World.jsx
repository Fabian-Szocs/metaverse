  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.div
        ...
        className="realtive mt-[68px] flex w-full h0-[550px]"
      >
        <img
          src="/map.png"
          alt="map"
        ...
        <div className="absolute bottom-[15%] right-[19%] w-[70px] p=[6px] rounded-full bg-[#5d6680]">
          <img
            src="/people-01.png" alt="people" className="w-full h-full"
          />
        </div>

        <div className="absolute top-[40%] left-[20%] w-[70px] p=[6px] rounded-full bg-[#5d6680]">
          <img
